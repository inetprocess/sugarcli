...
namespace SugarCli\Console\Command\CustomTables;
...
use SugarCli\Console\Command\Metadata;

class CleanCommand extends AbstractMetadataCommand
{
    protected function configure()
    {
        parent::configure();
        $this->setName('customtables:clean')
