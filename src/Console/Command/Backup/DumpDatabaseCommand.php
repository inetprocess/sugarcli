...
EOHELP
    ...
    protected function buildMysqldumpCommand(InputInterface $input)
    {
        ...
        // THIS CODE IS REDUNDANT TO OUTPUT PATH IN execute function
        // Define the output file path
        $timestamp = date('Y-m-d_H-i-s');
        $backup_folder_path = $input->getOption('destination-dir');
        $output_file = $backup_folder_path .'/'. $input->getOption('prefix') . '_'
        . gethostname() . '@'
        . $timestamp . '.sql.gz';
